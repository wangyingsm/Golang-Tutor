...
- 无符号整数类型
    - uint: 标准无符号整数（通常为32bits，4bytes）[0, 4294967296]
    - byte, uint8: 8位无符号整数（8bits，1bytes）[0, 256]
    - uint16: 16位无符号整数（16bits，2bytes）[0, 65536]
    - uint32: 32位无符号整数（32bits，4bytes）[0, 4294967296]
    - uint64: 64位无符号整数（64bits，8bytes）[0, 18446744073709551616]
- 浮点数类型
